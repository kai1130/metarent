...
contract CarCertificate is ERC721URIStorage  {
    ...
    constructor() ERC721("CarCertificate", "CarCertificate") {
        owner = msg.sender;
    }
    ...
    function claimDegree(string memory tokenURI)
        ...
        returns (uint256)
    {
        require(issuedDegrees[msg.sender], "Car Certificate is not issued");
